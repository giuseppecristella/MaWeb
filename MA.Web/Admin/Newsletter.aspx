            ...
            <div class="box-wrap clear">
                ...
                <asp:ListView ID="lvUsersSubscribed" runat="server" DataKeyNames="idUtente" DataSourceID="ObjectDataSourceMail"
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:Label runat="server" ID="lblRiga" Text=""></asp:Label></td>
                            <td><%#Eval("idUtente")%></td>
                            <td><%# Eval("email")%></td>
                            <td></td>
                            <td></td>
                ...
                <div class="tab-footer clear">
                    <asp:DataPager runat="server" ID="pager" PagedControlID="lvUsersSubscribed" PageSize="5">
                        <Fields>
            ...
            <div class="box-wrap clear">
                <div id="italiano">
                    <table class="style1">
                        ...
                        <tbody>
                            <tr>
                                <th>e-mail <span class="required">*</span>
                                </th>
                ...
                <div class="form-field clear">
                    <asp:Button CausesValidation="false" ID="btnAnnulla" CssClass="button red fr"
                        runat="server" Text="Cancel" OnClick="btnAnnulla_Click" Style="margin-left: 10px;" />
                    <asp:Button ID="btnInsert" CssClass="button green fr" runat="server" Text="Add e-mail"
            ...
            <div class="box-wrap clear">
                <div id="Div1">
                    <table class="style1">
                        ...
                        <tbody>
                            <tr>
                                <th>Newsletter <span class="required">*</span>
                                </th>
                                <td class="edit-field long" colspan="2">
                                    <FCKeditorV2:FCKeditor Height="400px" EnableViewState="false" ID="fckEdtTemplateNewsLetter" runat="server"
                ...
                <div class="form-field clear">
                    <%--buttons--%><asp:LinkButton CausesValidation="false" CssClass="button blue fl-space2" OnClientClick="return confirm('Confirm?')" OnClick="lnkbtnSaveTemplate_OnClick" ID="lnkbtnSaveTemplate" runat="server">Save Template</asp:LinkButton>
                    <asp:LinkButton CausesValidation="false" CssClass="button" OnClientClick="return confirm('Confirm?')" OnClick="lnkbtnSendNewsletter_Click" ID="lnkbtnSendNewsletter" runat="server">Send NewsLetter</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
