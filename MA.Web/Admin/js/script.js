...
// 		'aaSorting': [[1,'asc'], [6,'asc']],
		...
		'aoColumns': [ 
			...
			null,
			null,
			{ "bSortable": false },//di default sono tutte sortable e quindi disabilito quelle che non voglio rendere tali
			{ "bSortable": false },
			null
		]	
	});
...
function InitFancybox () {
	...
	$("a[href$='gif']").fancybox();
	$("a[href$='jpg']").fancybox();
	$("a[href$='png']").fancybox(); 	// aggiungere estensioni in maiuscolo musa!!
}
