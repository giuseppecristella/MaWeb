...
function LoadSelection()
{
	...
	if ( oLink )
	{
		...
		GetE('cmbLightboxValue').value = oLink.rel ;
		GetE('txtLightboxCaption').value = oLink.title ;
...
function UpdateImage( e, skipId )
{
	...
	// modifiche per lightbox
	SetAttribute( oLink, 'rel', GetE('cmbLightboxValue').value ) ;
	SetAttribute( oLink, 'title', GetE('txtLightboxCaption').value ) ;
	SetAttribute( oLink, 'class', 'imageLink' ) ;
