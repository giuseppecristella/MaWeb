...
public partial class shop_Default : BasePage
{
    ...
    protected void lvProductsShowCase_OnItemDataBound(object sender, ListViewItemEventArgs e)
    {
        ...
        if (lbGreenProductDetail != null) lbGreenProductDetail.HRef = FriendlyUrl.Href("~/Shop", "Dettaglio", product.product_id, product.name.Replace(" ","-").TrimEnd('-').ToLowerInvariant());
    }
