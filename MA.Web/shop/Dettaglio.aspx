    ...
    <form id="form1" runat="server">
        <div id="wrapper">
            <div class="center">
                ...
                <ul id="header-icons">
                    <li><a href="<%= FriendlyUrl.Href("~/Shop/Customers/Default") %>">Account Info</a></li>
                    <li><a href="<%= FriendlyUrl.Href("~/Shop/Customers/Ordini") %>">Ordini</a></li>
                        ...
                        <LoggedInTemplate>
                            <li>
                                ...
                                <asp:LoginStatus Style="float: right; margin-left: 10px;" runat="server" ID="logStatus"
                                    LoginText="Login" LogoutText="Logout" LogoutPageUrl="/shop/Default.aspx" CssClass="loginsubmit" />
                            </li>
                        </LoggedInTemplate>
                        <AnonymousTemplate>
                            <li><a href="<%= FriendlyUrl.Href("~/Shop/accedi") %>">Accedi</a></li>
                        </AnonymousTemplate>
                    </asp:LoginView>
                </ul>
                <div id="container">
