            ...
            <div id="container">
                ...
                <div id="content">
                    ...
                    <div style="min-height: 580px" class="one">
                        ...
                        <div style="width: 400px;" class="one-half last">
                            <%-- <h4>
                            <asp:Literal runat="server" ID="ltrTitleProd"></asp:Literal></h4>--%>
                            <%--   <p> </p>--%>
                            <asp:Literal runat="server" ID="prodDescription"></asp:Literal>
                            <%--<label>Modello:
                        <asp:Literal runat="server" ID="prodNameDesc"></asp:Literal></label>--%>
                            <label>
                                Prezzo: €.
                            ...
                            <%--  <label>
                            Qta:
                            <asp:TextBox runat="server" Text="1" ID="prodQta" Style="width: 20px;"></asp:TextBox>
                    ...
                    <div runat="server" id="divSpotRosso" visible="false" style="padding: 20px 0 5px 0;
                        ...
                        <!-- HEADER  -->
                        <!-- LOGO -->
                        <a style="background: transparent url('images/logo-design.png') no-repeat; display: block;
                            float: left; width: 220px; height: 70px; text-indent: -9999px;" id="A1" title="Homepage"
                            href="design.html"></a>
                        <!--LOGO ENDS  -->
                    ...
                    <div runat="server" id="divSpotVerde" visible="false" style="padding: 20px 0 5px 0;
                        ...
                        <!-- HEADER  -->
                        <!-- LOGO -->
                        <a style="background: transparent url('images/logo-tradizione.png') no-repeat; display: block;
                            float: left; width: 220px; height: 70px; text-indent: -9999px;" id="A2" title="Homepage"
                            href="tradizione.html"></a>
                        <!--LOGO ENDS  -->
