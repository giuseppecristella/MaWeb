<%@ Page Title="" Language="C#" MasterPageFile="~/shop/Default.master" AutoEventWireup="true"
    CodeFile="Home_v.aspx.cs" Inherits="shop_Home_v" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderWrapper" runat="Server">
            ...
            <div id="slides">
                <div id="slider-big">
                    <div class="slides_container big-slider">
                        ...
                        <div class="slide">
                            <img src="images/slideshow/slide-verde-01.jpg" alt=" " width="960" height="400" />
                        </div>
                        <div class="slide">
                            <img src="images/slideshow/slide-verde-02.jpg" alt=" " width="960" height="400" />
                        </div>
                        <div class="slide">
                            <img src="images/slideshow/slide-verde-03.jpg" alt=" " width="960" height="400" />
                        </div>
                        <div class="slide">
                            <img src="images/slideshow/slide-verde-04.jpg" alt=" " width="960" height="400" />
                        </div>
                    </div>
    ...
    <div class="one">
        ...
        <div class="one-third last">
            <a href="design.html" id="tasto-design">vai allo shop design e casa </a>
        </div>
    </div>
    <div style="padding-top: 40px;" class="one">
        <div class="headline">
            <h4>
                Le offerte del <span class="colored">Mese</span></h4>
        </div>
    ...
    <div style="padding-top: 40px; padding-bottom: 20px;" class="one">
        <div class="headline">
            <h4>
                Le offerte dello Shop <span style="color: #D10A11;" class="colored">Design Casa</span></h4>
        </div>
