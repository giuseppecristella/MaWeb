<%@ Page Title="" Language="C#" MasterPageFile="~/shop/Customers/Default.master" AutoEventWireup="true"
            ...
            <!--  HEADER ENDS-->
                ...
                <div style="padding:20px 0 20px 0;min-height:580px;" class="one">
                    ...
                    <div style="margin-left:30px;width:305px;" class="one-third">
                        ...
                        <fieldset>
                         <label>Cognome:</label>
                        <asp:Label runat="server" ID="lblCognome"></asp:Label></fieldset>
                         <fieldset>
                         <label>E-mail:</label>
                        <asp:Label runat="server" ID="lblEmail"></asp:Label></fieldset>
                    </div>
