<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mPromoDettaglio.aspx.cs"
    Inherits="mobile_PromoDett" %>
            ...
            <div class="left">
                <a href="Default.aspx" class="showMenu menu-button">
                    <img src="images/menu-button.png" width="16" /></a>
                     ...
                     <a href="promozioni.aspx" class="back-button"><img src="images/back-button.png" width="40" /></a>
            </div>
            <h1>
                <p class="no-margin">
                    Promozioni</p>
                ...
                <ul class="gallery photoswipe column-split  one-column">
                    ...
                    <asp:Repeater DataSourceID="objPromo" runat="server" ID="Repeater1">
                        <ItemTemplate>
                            ...
                            <li>
                            <a data-ajax="false" href='../<%#(Eval("UrlFotoHome").ToString().Replace("\\","/")) %>'>
                            
                                <img src='../<%#(Eval("UrlFotoHome").ToString().Replace("\\","/")) %>' alt="" /></a>
                            </li>
                        </ItemTemplate>
                    </asp:Repeater>
