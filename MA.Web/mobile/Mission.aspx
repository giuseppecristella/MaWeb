<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mission.aspx.cs" Inherits="mobile_Mission" %>
...
<body>
    ...
    <div data-dom-cache="false" data-role="page" class="pages" id="home" data-theme="a">
        ...
        <div class="white-content-box">
                ...
                <p>Il nostro business è garantire serenità. Di conseguenza la gente deve potersi fidare di noi e non può farlo se non agiamo in modo eticamente responsabile e non sviluppiamo con i nostri clienti delle relazioni corrette e positive che li lascino entusiasti del servizio ricevuto.</p>
               
                <p>Rispettare ogni persona e le sue idee incoraggiare lo spirito di iniziativa dei suoi collaboratori, offrendo loro crescita professionale e benessere economico.</p>
          <p>Contribuire allo sviluppo della comunità esercitando funzioni di guida nella pratica dei nostri valori.</p>  
           <p>
           Il Cliente è il Nostro Primo Patrimonio, Vendiamo Qualità Consulenza ed Emozioni. 
           </p>
            </div>
