<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mCatalogo.aspx.cs" Inherits="mobile_Catalogo" %>
                ...
                <ul class="shadow-inner-images gallery column-split flexible-column">
                    <asp:ListView runat="server" ID="lvProducts" OnItemDataBound="item_dataBound">
                        ...
                        <ItemTemplate>
                         ...
                         <li><a runat="server" id="lnkDettaglio_1" data-transition="slide" class="center little-padding">
                        <asp:Image ImageUrl="../Handler.ashx" runat="server" ID="imgProduct" />
                        <br /><b> 
                       <p runat="server" id="priceProduct" class="desc_prezzo_home verde">
                            </p></b>
                        
                        <span style="height: 50px;display:block;" runat="server"
                                    id="descProduct" class="desc_prodotto_home"></span> </a>
                                   </li>
